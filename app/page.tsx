...
import { activeProviderServer, formatPlanPrice, PRO_PLAN_USD } from "@/lib/payments";
    ...
    <>
      ...
      <section className="relative isolate min-h-dvh overflow-hidden">
        ...
        <div className="relative z-10 flex min-h-dvh flex-col px-4 sm:px-6">
          ...
          <div className="mx-auto flex w-full max-w-4xl shrink-0 flex-wrap items-center justify-center gap-x-6 gap-y-3 px-2 pt-4 text-sm">
            {FORMATS.map((f, i) => (
      ...
      <section className="relative z-10 border-t border-white/5 bg-black">
        <div className="mx-auto max-w-6xl px-4 py-24 sm:px-6">
          ...
          <p className="mx-auto mt-10 max-w-2xl text-pretty text-center text-neutral-400">
            ...
            <span className="font-display-italic text-white">{formatPlanPrice()} / 30 days</span>,
            payable in USDT on-chain.
          </p>
        </div>
      </section>
            ...
            <div className="relative overflow-hidden rounded-3xl border border-fuchsia-400/20 bg-gradient-to-b from-fuchsia-500/[0.07] to-transparent p-7 shadow-[0_0_80px_-30px_rgba(217,70,239,0.6)]">
              ...
              <div className="relative">
                ...
                <div className="mt-1 flex items-baseline gap-2">
                  <span className="font-display text-3xl text-white">{formatPlanPrice()}</span>
                  <span className="text-sm text-neutral-400">/ 30 days</span>
                </div>
                <p className="mt-1 text-sm text-neutral-500">
                  {paymentsProvider === "direct_usdt"
                    ? "Pay in USDT (TRC-20 or ERC-20). On-chain verification — instant Pro."
